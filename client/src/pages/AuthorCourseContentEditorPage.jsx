...
const AUTHOR_MODES = [
  { id: 'improve_text', label: 'Улучшить стиль', icon: '📝' },
  { id: 'generate_task', label: 'Создать задание', icon: '🎯' },
  { id: 'structure', label: 'Составить план', icon: '📑' },
];
...
const AUTHOR_MODE_DESCRIPTIONS = {
  ...
  improve_text: "Повышает читаемость лекции, исправляет опечатки, упрощает сложные фразы и улучшает стиль.",
  generate_task: "Помогает придумать практическое задание, тестовые случаи, варианты ответов и подсказки по теме урока.",
  structure: "Помогает разбить сложную тему на логические блоки, составить пошаговый план урока и придумать заголовки."
};
