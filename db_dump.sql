...
\restrict QTywa6ncQaB1Kx5oXbHHzRQyhMHpcleMcef4NTpB02qNArm3qqdKwkKQbEp2tUk
...
40	5	1	2026-06-01 20:02:56.007131
46	4	1	2026-06-02 11:59:54.293689
\.
...
12	1	practice	Первая строчка кода "Hello world!"	Для вывода различных типов данных в JavaScript важно понимать, как правильно использовать кавычки.\n\nЧисла: если вы хотите вывести число, то указываете его без кавычек:\nconsole.log(100);\nСтроки: для вывода слов или фраз используйте двойные или одинарные кавычки:\nconsole.log("Строка 1");\nconsole.log('Строка 2');	{"options": [], "quiz_type": "single", "task_type": "code", "test_cases": [{"input": "", "is_hidden": false, "expected_output": "Hello world!"}], "placeholder_code": "console.log()"}		2	2026-05-17 17:50:30.10969
17	6	practice	Создание функций.	// Задание: напишите функцию, которая принимает массив чисел и возвращает объект с двумя свойствами:\n// sum — сумма всех чисел массива\n// avg — среднее арифметическое чисел массива	{"options": [], "quiz_type": "single", "task_type": "code", "test_cases": [{"input": "[1, 2, 3, 4, 5]", "is_hidden": false, "expected_output": "{\\"sum\\":15,\\"avg\\":3}"}, {"input": "[10, 20, 30]", "is_hidden": false, "expected_output": "{\\"sum\\":60,\\"avg\\":20}"}, {"input": "[-1, 0, 1]", "is_hidden": false, "expected_output": "{\\"sum\\":0,\\"avg\\":0}"}], "function_name": "arrayStats", "placeholder_code": "// Шаблон для функции\\r\\nfunction arrayStats(numbers) {\\r\\n    // Здесь напишите код для вычисления суммы и среднего арифметического\\r\\n    return { sum, avg };\\r\\n}\\r\\n"}		1	2026-06-01 20:19:02.06599
18	9	lecture	Методический материал.		{"options": [], "quiz_type": "single"}	[{"original_name":"ВЛАСОВ_АД_ВКР_30_05_26  (2).docx","stored_name":"e8b357bf-81d9-4039-b23f-cc13e7de54d8.docx","url":"/api/attachments/e8b357bf-81d9-4039-b23f-cc13e7de54d8.docx","size":10498651,"mime_type":"application/vnd.openxmlformats-officedocument.wordprocessingml.document","uploaded_at":"2026-06-01T21:09:51.089Z"}]	1	2026-06-01 21:09:35.861143
5	1	test	Применение JavaScript	Где лучше использовать JavaScript? Выберите два правильных варианта ответа:	{"options": [{"hint": "JavaScript не подходит для создания статичных веб-сайтов в качестве основного инструмента, так как его сила заключается в добавлении интерактивности и динамического поведения, а не в создании структуры и внешнего вида сайта.", "text": "Для создания статичных веб-сайтов.", "is_correct": false}, {"hint": "", "text": "Для разработки интерактивных веб-приложений.", "is_correct": true}, {"hint": "Cуществуют среды, позволяющие использовать JavaScript для программирования микроконтроллеров, это не является основным или наиболее распространённым применением языка. Для таких задач чаще используются другие языки программирования, специально предназначенные для работы с аппаратным обеспечением.", "text": "Для создания онлайн-игр и анимации", "is_correct": true}], "quiz_type": "multiple", "task_type": "code", "test_cases": [{"input": "1 2 3", "is_hidden": false, "expected_output": "6"}, {"input": "2 3 3", "is_hidden": false, "expected_output": "8"}, {"input": "1 2 2", "is_hidden": false, "expected_output": "5"}], "function_name": "sum", "placeholder_code": "function sum(x,y,z) {\\n}"}		3	2026-05-08 13:22:19.674633
1	1	lecture	Зачем нужен JavaScript	Добро пожаловать на наш курс! Сегодня мы начнём с простого, но важного шага — знакомства. В этой лекции мы поговорим о том, почему знакомство важно, и как оно помогает в общении.\n\nJavaScript — это язык программирования, который широко используется для создания интерактивных и динамичных веб-сайтов. Вот несколько ключевых областей применения JavaScript:\n\nВеб-разработка: JavaScript позволяет добавлять интерактивность на веб-страницы, обрабатывать пользовательский ввод и взаимодействовать с сервером без перезагрузки страницы.\nМобильные приложения: с помощью фреймворков, таких как React Native и Ionic, JavaScript используется для разработки мобильных приложений.\nДесктопные приложения: Electron и другие инструменты позволяют создавать десктопные приложения с использованием JavaScript.\nИгры: JavaScript используется для создания игр, особенно в вебе, с помощью библиотек и фреймворков, таких как Phaser и Babylon.js.\nСерверная разработка: с появлением Node.js JavaScript стал использоваться для разработки серверного программного обеспечения, что позволяет создавать масштабируемые сетевые приложения.	{"options": [], "quiz_type": "single"}		1	2026-05-07 13:24:08.343317
19	1	test	Тест	ТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТТЕКСТ	{"options": [{"hint": "", "text": "Правильный ответ", "is_correct": true}, {"hint": "", "text": "Неправильный ответ", "is_correct": false}], "quiz_type": "single"}		4	2026-06-02 12:14:47.307563
\.
...
1	1	Введение в JavaScript	1	2026-05-07 13:23:54.317843
2	1	Переменные и типы данных	2	2026-05-10 16:05:49.52593
3	1	Операторы и выражения	3	2026-05-10 16:06:19.947054
9	1	Условные операторы и циклы	4	2026-05-10 16:29:57.772999
4	1	Массивы	6	2026-05-10 16:21:42.72417
12	1	Объекты	7	2026-05-10 16:30:01.444034
11	1	Работа с DOM	8	2026-05-10 16:29:59.901342
13	1	События	9	2026-05-10 16:39:57.69985
10	1	Асинхронное программирование	10	2026-05-10 16:29:59.022213
14	1	Работа с AJAX	11	2026-05-10 16:39:58.793092
5	1	Основы React	12	2026-05-10 16:21:43.833208
15	1	Работа с API	13	2026-05-10 16:39:59.665816
17	1	Тестирование JavaScript-кода	14	2026-05-10 16:40:01.13677
18	1	Лучшие практики и рекомендации	15	2026-05-10 16:40:02.282894
6	1	Функции	5	2026-05-10 16:21:50.425847
\.
...
13	5	1	1	5	2026-06-01 20:03:59.986365
14	4	1	1	5	2026-06-02 12:00:04.816779
\.
...
8	5	5	[0]	f	2026-06-01 20:03:01.64929
9	5	5	[0, 2]	f	2026-06-01 20:03:10.633451
10	5	5	[0, 2]	f	2026-06-01 20:03:11.813332
11	5	5	[0, 1]	f	2026-06-01 20:03:13.268091
12	5	5	[1]	t	2026-06-01 20:03:59.981942
13	4	5	[0]	f	2026-06-02 12:00:02.92773
14	4	5	[1, 2]	t	2026-06-02 12:00:04.803209
\.
...
5	Crotchety	foxi82911@gmail.com	$2b$10$qplndE5Xkdquh9iB5UNNo.SEkbUV7chVVfccH7Xn8ZKf5UPsB6caW	student	2026-06-01 20:02:52.251966	\N	\N
1	Andrey	andrey.vlasovx@gmail.com	$2b$10$n.A9T97/GSpTC6A7hsJ4t.KLvjTvHZI2z1jwBRUk86zkZDUcKLm7u	author	2026-05-07 13:23:29.929256	v1:23bbdrpZeZT1az2G:Sc8v0RnuqPlJ+7VMhvn4MQ==:m4oatoWC3niFj3BokAERP+quCpJNiXKn3ygMFTLomHyF5MEy4YK9+A==	b1g8aavaikfdoji0bish
\.
...
SELECT pg_catalog.setval('public.enrollments_id_seq', 48, true);
...
SELECT pg_catalog.setval('public.lesson_blocks_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.user_course_progress_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.user_quiz_attempts_id_seq', 14, true);
...
\unrestrict QTywa6ncQaB1Kx5oXbHHzRQyhMHpcleMcef4NTpB02qNArm3qqdKwkKQbEp2tUk
